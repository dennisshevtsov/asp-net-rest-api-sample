...
namespace AspNetRestApiSample.Infrascruture.Configurations
{
  ...
  using AspNetRestApiSample.Infrascruture.ValueGeneration;
    ...
    where TEntity : TodoListEntityBase
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.ApplicationCore.Database.Configurations.TodoListEntityTypeConfigurationBase{TEntity}"/> class.</summary>
