...
namespace AspNetRestApiSample.Infrascruture.Configurations
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.ApplicationCore.Database.Configurations.TodoListEntityTypeConfiguration"/> class.</summary>
    ...
    /// <summary>Configures the entity of type <see cref="AspNetRestApiSample.ApplicationCore.Entities.TodoListEntity"/>.</summary>
