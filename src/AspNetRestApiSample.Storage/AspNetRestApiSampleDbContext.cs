...
namespace AspNetRestApiSample.Storage
{
  ...
  using AspNetRestApiSample.Configurations;
  ...
  public sealed class AspNetRestApiSampleDbContext : DbContext
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.Storage.AspNetRestApiSampleDbContext"/> class.</summary>
