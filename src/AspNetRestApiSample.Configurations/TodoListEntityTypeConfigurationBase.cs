...
namespace AspNetRestApiSample.Configurations
{
  ...
  using AspNetRestApiSample.ValueGeneration;
    ...
    where TEntity : TodoListEntityBase
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.Configurations.TodoListEntityTypeConfigurationBase{TEntity}"/> class.</summary>
