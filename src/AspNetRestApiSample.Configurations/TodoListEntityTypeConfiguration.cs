...
namespace AspNetRestApiSample.Configurations
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.Configurations.TodoListEntityTypeConfiguration"/> class.</summary>
    ...
    /// <summary>Configures the entity of type <see cref="AspNetRestApiSample.Entities.TodoListEntity"/>.</summary>
