...
namespace AspNetRestApiSample.Configurations
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.Configurations.TodoListTaskEntityTypeConfiguration"/> class.</summary>
    ...
    /// <summary>Configures the entity of type <see cref="AspNetRestApiSample.Entities.TodoListTaskEntityBase"/>.</summary>
