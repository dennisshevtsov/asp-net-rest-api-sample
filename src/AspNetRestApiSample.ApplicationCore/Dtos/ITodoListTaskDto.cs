...
namespace AspNetRestApiSample.ApplicationCore.Dtos
{
  ...
  {
    /// <summary>Gets an object that represents a title of a todo list task.</summary>
    public string? Title { get; }

    /// <summary>Gets an object that represents a description of a todo list task.</summary>
    public string? Description { get; }

    /// <summary>Gets an object that represents a type of a TODO list task.</summary>
