...
namespace AspNetRestApiSample.Database.Configurations
{
  ...
  {
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.Database.Configurations.TodoListTaskEntityTypeConfiguration"/> class.</summary>
    ...
    /// <summary>Configures the entity of type <see cref="AspNetRestApiSample.Database.Entities.TodoListTaskEntityBase"/>.</summary>
