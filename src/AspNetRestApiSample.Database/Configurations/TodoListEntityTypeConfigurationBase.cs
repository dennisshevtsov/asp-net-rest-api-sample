...
namespace AspNetRestApiSample.Database.Configurations
{
  ...
  using AspNetRestApiSample.Database.ValueGeneration;
    ...
    where TEntity : TodoListEntityBase
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.Database.Configurations.TodoListEntityTypeConfigurationBase{TEntity}"/> class.</summary>
