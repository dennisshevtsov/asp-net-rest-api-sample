...
namespace AspNetRestApiSample.Database
{
  ...
  using AspNetRestApiSample.Database.Configurations;
  ...
  public sealed class AspNetRestApiSampleDbContext : DbContext
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.Database.AspNetRestApiSampleDbContext"/> class.</summary>
