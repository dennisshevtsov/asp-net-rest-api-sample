...
namespace AspNetRestApiSample.WebApi.Controllers
{
  using System;
  ...
  public sealed class TodoListTaskController : ControllerBase
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="AspNetRestApiSample.WebApi.Controllers.TodoListTaskController"/> class.</summary>
    /// <param name="todoListService">An object that provides a simple API to a storage of instances of the <see cref="AspNetRestApiSample.ApplicationCore.Entities.TodoListEntity"/> class.</param>
    /// <param name="todoListTaskService">An object that provides a simple API to a storage of the <see cref="AspNetRestApiSample.ApplicationCore.Entities.TodoListTaskEntityBase"/> class.</param>
